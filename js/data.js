...
window.GAME_DATA = (function () {
  ...
  /* ---------- 经济参数总表（v1.24） ----------
     ...
     刻意没动的（守住平衡）：护理道具价格、修建与托位价格、
     破壳/挑战赛及格率、券的产出。豆和券仍是两套互不串味的货币。
     （状态衰减速度原本也列在"不动"里，v1.35 因「小生物多了照看不过来」的反馈单独调慢了
  ...
  /* ---------- 题库（这就是那个「端口」） ----------
     ...
     v1.38 加入 0923 批次 70 题（cuoti_222 ~ cuoti_291），来自松果桌面「错题集/921-23错题.md」：
     通用&出境实务 10 + 辽宁 10 + 吉林 8 + 黑龙江 9 + 业务/旅游史/法规 17 + 江苏 7 + 上海 6 + 河南 3。
     这批是各省概况，科目按章节显式标成 loc（科目四 地方导游基础知识）—— 靠关键词猜会全落进 nat。
     md → 草稿用 dev/import_wrong_md.py，再 dev/build_qbank.js --no-dedup 写进来。
  ...
  const QUESTION_BANK = [
    ...
    { id: "cuoti_140", subject: "nat", type: "tf", stem: "中国国航、深圳航空是国际航空联盟中天合联盟的成员。( )", options: ["错", "对"], answer: 0, explain: "我国的东方航空、厦门航空是天合联盟的成员。 本题中两个航空公司均不是。故本题错误。 题库维护人：WYF" },
    { id: "cuoti_141", subject: "ops", type: "tf", stem: "普通旅客乘坐火车，可以免费携带物品的重量是 30千克。( )", options: ["错", "对"], answer: 0, explain: "普通旅客乘坐火车，可以免费携带物品的重量是 20千克。故本题错误。 题库维护人：WYF 笔记十随手记" },
    { id: "cuoti_142", subject: "ops", type: "tf", stem: "在国际航空运输中，承运人对每名旅客伤害的赔偿限额为15600计算单位。()", options: ["错", "对"], answer: 0, explain: "在国际航空运输中，承运人对每名旅客伤害的赔偿限额为16600计算单位。故本题错误。 题库维护人：WYF 笔记十随手记" },
    { id: "cuoti_143", subject: "nat", type: "tf", stem: "我国国际航班的航班号由执行该航班的航空公司的英文字母代码和三位阿拉伯数字组成。( )", options: ["错", "对"], answer: 1, explain: "我国国际航班的航班号由执行该航班任务的航空公司的英文字母代码和三位阿拉伯数字组成。其中第一位数字是航空公司的数字代码。例如，中国国际航空公司的数字代码为9,中国南方航空公司的数字代码为3,东方航空公司的数字代码为5 等。后两位是航班序号，单数为去程，双数为回程。CA919是指中国国际航空公司自北京飞往东京的航班，CA977为中国国际航空公司自北京飞往新加坡的航班。 题库维护人：WYF" },
    { id: "cuoti_144", subject: "ops", type: "tf", stem: "世界三大国际航空客运联盟中总部设在美国的是星空联盟。( )", options: ["错", "对"], answer: 0, explain: "星空联盟(StArAlliance),成立于1997年，总部位于德国法兰克福。故本题错误。 题库维护人：WYF 笔记十随手记" },
    { id: "cuoti_145", subject: "ops", type: "tf", stem: "团体旅客办理的车票，在改签、退票时，应不晚于开车前72小时。( )", options: ["错", "对"], answer: 0, explain: "团体旅客办理的车票，在改签、退票时，应不晚于开车前48小时。故本题错误。 题库维护人：WYF 笔记十随手记" },
    { id: "cuoti_146", subject: "ops", type: "tf", stem: "普通旅客乘坐动车时，可以免费携带的杆状物品的长度不能超过160厘米。()", options: ["错", "对"], answer: 0, explain: "普通旅客乘坐动车时，可以免费携带的杆状物品的长度不能超过130厘米。故本题错误。 题库维护人：WYF 笔记十随手记" },
    { id: "cuoti_147", subject: "ops", type: "tf", stem: "乘坐沿海和长江客轮，游客可携带的免费行李为 50千克。( )", options: ["错", "对"], answer: 0, explain: "乘坐沿海和长江客轮，游客可携带免费行李20千克，而不是50千克。故本题错误。 题库维护人：WYF 笔记十随手记" },
    { id: "cuoti_148", subject: "law", type: "tf", stem: "根据国家民航局规定，年满14周岁的旅客应购买成人机票。()", options: ["错", "对"], answer: 0, explain: "根据国家民航局规定，年满12周岁的旅客应购买成人机票。 题库维护人：WYF 笔记十随手记" },
    { id: "cuoti_149", subject: "ops", type: "tf", stem: "对特区直接行使权力的机关有全国人大、全国人大常委会、国务院和最高人民法院。()", options: ["错", "对"], answer: 0, explain: "对特区直接行使权力的机关有全国人大、全国人大常委会和中央人民政府。 题库维护人：CZP" },
    { id: "cuoti_150", subject: "law", type: "tf", stem: "因同一行为应当承担侵权责任和行政责任、刑事责任，侵权人的财产不足以支付的，先承担刑事责任。()", options: ["错", "对"], answer: 0, explain: "因同一行为应当承担侵权责任和行政责任、刑事责任，侵权人的财产不足以支付的，先承担侵权责任。 题库维护人：CZP" },
    { id: "cuoti_151", subject: "ops", type: "tf", stem: "旅游服务热线是12308。( )", options: ["错", "对"], answer: 0, explain: "建立统一受理旅游投诉举报机制，积极运用 “12301”智慧旅游服务平台、“12345”政府服务热线以及手机APP、微信公众号、咨询中心等多种手段，形成线上线下联动、高效便捷畅通的旅游投诉举报受理、处理、反馈机制，做到及时公正，规范有效。 题库维护人：CZP" },
    { id: "cuoti_152", subject: "ops", type: "tf", stem: "旅游行政主管部门应按照“属人管理、部门联动、 行业自律、各司其职、齐抓共管”的原则，建立对旅游市场执法、投诉受理工作的有效协调机制，明确各相关部门责任。()", options: ["错", "对"], answer: 0, explain: "旅游行政主管部门应按照“属地管理、部门联动、 行业自律、各司其职、齐抓共管”的原则，建立对旅游市场执法、投诉受理工作的有效协调机制， 明确各相关部门责任。 题库维护人：CZP" },
    { id: "cuoti_153", subject: "law", type: "tf", stem: "旅游合同是双务、有偿、诺成合同。()", options: ["错", "对"], answer: 1, explain: "旅游服务合同，是指旅游经营者与旅游者约定旅游活动过程中旅行社和旅游者之间权利义务关系的协议。具有以下法律特征：①是双务、有偿、 诺成合同；②合同标的具有特殊性，是一种旅游经历以及为获得这种经历所必需的食、住、行、 游、购、娱等旅游服务条件；③多为格式合同。 题库维护人：CZP 令5" },
    { id: "cuoti_154", subject: "nat", type: "single", stem: "第十二届全国人民代表大会常务委员会第十一次会议决定：将每年的( )设立为“国家宪法日”", options: ["4月10日", "5月26日", "10月10日", "12月4日"], answer: 3, explain: "每年的12月4日设立为“国家宪法日”。 题库维护人：CZP" },
    { id: "cuoti_155", subject: "nat", type: "tf", stem: "巫傩文化起源于华夏先民的自然崇拜、图腾崇拜和巫术意识。()", options: ["错", "对"], answer: 0, explain: "“傩”是历史久远并广泛流行于汉民族中的具有强烈宗教和艺术色彩的社会文化现象，它起源于汉族先民的自然崇拜、图腾崇拜和巫术意识。 题库维护人：CZP" },
    { id: "cuoti_156", subject: "ops", type: "tf", stem: "天津于1840年被辟为通商口岸。( )", options: ["错", "对"], answer: 0, explain: "天津于1860年被辟为通商口岸。 题库维护人：CZP" },
    { id: "cuoti_157", subject: "ops", type: "tf", stem: "上海文学主要是海派文学。()", options: ["错", "对"], answer: 1, explain: "上海文学主要是海派文学。 题库维护人：CZP 笔记 + 随手记" },
    { id: "cuoti_158", subject: "nat", type: "tf", stem: "内蒙古的森林总面积位居全国第二。()", options: ["错", "对"], answer: 0, explain: "内蒙古的森林总面积位居全国第一。 题库维护人：CZP 笔记 + 随手记内蒙古的森林总面积位居全国第一 0 40 4nn..4共办n .L 上体" },
    { id: "cuoti_159", subject: "ops", type: "tf", stem: "连云港的市郊云台山玉女峰为江苏第二高峰。()", options: ["错", "对"], answer: 0, explain: "云台山玉女峰为江苏最高峰。 题库维护人：CZP 笔记 + 随手记云台山玉女峰最高峰" },
    { id: "cuoti_160", subject: "nat", type: "tf", stem: "狮舞可以分为北狮和南狮两种。南狮狮头有脸谱化的特点。红脸代表勇猛、霸气。黑脸代表忠义、胜利。()", options: ["错", "对"], answer: 0, explain: "中国的舞狮分为北狮和南狮，南狮狮头有脸谱化的特点：黄脸为刘备狮，代表仁义；红脸为关公狮，代表忠义、胜利；黑脸为张飞狮，代表勇猛、霸气等。 题库维护人：CZP" },
    { id: "cuoti_161", subject: "ops", type: "tf", stem: "上海本帮菜指的是上海本帮饭店的菜肴。()", options: ["错", "对"], answer: 0, explain: "上海本帮菜指的是上海本地风味的菜肴。 题库维护人：CZP 笔记 + 随手记是本地风味不是本地饭店 0r 0 or n.07 1.+7 L上些" },
    { id: "cuoti_162", subject: "nat", type: "single", stem: "船形屋是()的一种传统居住房屋", options: ["苗族", "侗族", "畲族", "黎族"], answer: 3, explain: "海南是我国黎族的聚居地。船形屋、黎族织锦与服饰、竹筒饭、山兰酒、黎族舞蹈和民歌、黎家三月三活动，都体现了黎族颇具特色的民族文化和风情。 题库维护人：CZP 理今" },
    { id: "cuoti_163", subject: "nat", type: "single", stem: "岫岩玉雕是()省的传统工艺美术品?", options: ["河南", "辽宁", "陕西", "新疆"], answer: 1, explain: "工艺美术制品方面，抚顺煤精雕、岫岩玉雕和辽西玛瑙雕为辽宁三大雕刻工艺品 A河南南阳玉.C陕西蓝田玉.D新疆和田玉题库维护人：CZP" },
    { id: "cuoti_164", subject: "nat", type: "single", stem: "“望果节”是()的传统节日", options: ["回族", "藏族", "满族", "蒙古族"], answer: 1, explain: "“望果节”是藏族渴望丰收的传统节日。“望果”是藏语译音，“望”藏语意思是田地、土地，“果”意为转圈，意为“绕地头转圈”。 题库维护人：CZP" },
    { id: "cuoti_165", subject: "nat", type: "single", stem: "被称为“万丈盐桥”的察尔汗盐湖位于我国的()", options: ["青海省", "新疆维吾尔自治区", "甘肃省", "内蒙古自治区"], answer: 0, explain: "察尔汗盐湖，是中国青海省西部的一个盐湖，与茶卡盐湖齐名，位于青海省柴达木盆地南部。 题库维护人：CZP" },
    { id: "cuoti_166", subject: "nat", type: "single", stem: "刀削面、猫耳朵、莜面栲栲是()的美食特产", options: ["陕西省", "山西省", "甘肃省", "青海省"], answer: 1, explain: "刀削面、猫耳朵、莜面栲佬是山西省的美食特产。 题库维护人：CZP" },
    { id: "cuoti_167", subject: "ops", type: "tf", stem: "鲁菜的口味特点是清爽平和，清鲜而略带甜味，咸甜适中。()", options: ["错", "对"], answer: 0, explain: "鲁菜讲究调味醇正，口味偏于咸鲜，具有鲜、 嫩、香、脆的特色。 题库维护人：WYF" },
    { id: "cuoti_168", subject: "ops", type: "tf", stem: "徽墨产于古徽州府。()", options: ["错", "对"], answer: 1, explain: "徽墨产于古徽州府。 题库维护人：WYF 笔记 + 随手记" },
    { id: "cuoti_169", subject: "nat", type: "tf", stem: "皇家园林的特点是范围小，主题突出，常用假山假水，造园技艺高超。()", options: ["错", "对"], answer: 0, explain: "私家园林的特点是范围小，主题突出，常用假山假水，造园技艺高超。 题库维护人：WYF 笔记十随手记" },
    { id: "cuoti_170", subject: "nat", type: "tf", stem: "长江上游景观凶险多峡谷，占长江总长度的1/3以上。()", options: ["错", "对"], answer: 0, explain: "长江上游景观凶险多峡谷，占长江总长度的2/3以上。 题库维护人：WYF 笔记十随手记" },
    { id: "cuoti_171", subject: "ops", type: "tf", stem: "1985年旅游业被国家确定为经济产业，推动了旅游业向产业化方向发展，国内旅游市场呈现出一派勃勃生机。()", options: ["错", "对"], answer: 1, explain: "1985年旅游业被国家确定为经济产业，推动了旅游业向产业化方向发展，国内旅游市场呈现出一派勃勃生机。 题库维护人：WYF" },
    { id: "cuoti_172", subject: "ops", type: "tf", stem: "华严宗对毗卢遮那佛的崇拜取代了对他佛的崇拜", options: ["错", "对"], answer: 1, explain: "华严宗对毗卢遮那佛的崇拜取代了对他佛的崇拜。故有的寺院专门供奉“华严三圣”。 题库维护人：WYF" },
    { id: "cuoti_173", subject: "nat", type: "tf", stem: "回族是我国少数民族中人口最多，分布最广的民族。()", options: ["错", "对"], answer: 0, explain: "我国少数民族中人口最多的是壮族，回族是分布最广的民族。 题库维护人：WYF 笔记十随手记" },
    { id: "cuoti_174", subject: "ops", type: "tf", stem: "苦谛是对造成痛苦与烦恼原因的分析，大体可以概括为“五阴聚合说”“十二因缘”说和“业报轮回”说", options: ["错", "对"], answer: 0, explain: "集谛是对造成人生痛苦原因的分析，大体可以概括为“五阴聚合说”“十二因缘”说和“业报轮回”说。 题库维护人：WYF 笔记 + 随手记" },
    { id: "cuoti_175", subject: "ops", type: "tf", stem: "苏州有七十二泉，“家家泉水，户户垂杨”,有“泉城” 之誉。()", options: ["错", "对"], answer: 0, explain: "济南有七十二泉，“家家泉水，户户垂杨”,有“泉城”之誉。 题库维护人：WYF 笔记十随手记岭5S0" },
    { id: "cuoti_176", subject: "nat", type: "tf", stem: "《“十四五”旅游业发展规划》要求把国家公园建设成为传承中华文明的历史文化走廊、中华民族共同精神家园、提升人民生活品质的文化和旅游体验空间", options: ["错", "对"], answer: 0, explain: "国家公园改为国家文化公园" },
    { id: "cuoti_177", subject: "law", type: "tf", stem: "国务院总理、副总理连续任职不得超过两届，国务委员连续任职无限制要求。()", options: ["错", "对"], answer: 0, explain: "国务院总理、副总理、国务委员连续任职不得超过两届。 题库维护人：CZP" },
    { id: "cuoti_178", subject: "law", type: "tf", stem: "按经营范围划分，旅行社分为国内旅游和出入境旅游两类", options: ["错", "对"], answer: 0, explain: "《旅游法》第29条规定，旅行社可以经营下列业务：①境内旅游；②出境旅游；③边境旅游；④ 入境旅游；⑤其他旅游业务。旅行社应当按照核定的业务范围开展经营活动，严禁超范围经营。 竿记 R随王记" },
    { id: "cuoti_179", subject: "law", type: "tf", stem: "根据《大型群众性活动安全管理条例》,大型群众性活动，是指法人或者其他组织面向社会公众举办的每场次预计参加人数达到1000人以上游园、灯会、庙会、花会、焰火晚会等活动", options: ["错", "对"], answer: 1, explain: "《条例》第2条规定，大型群众性活动是指法人或者其他组织面向社会公众举办的每场次预计参加人数达到1000人以上的下列活动：①体育比赛活动；②演唱会、音乐会等文艺演出活动；③展览、展销等活动；④游园、灯会、庙会、花会、 焰火晚会等活动；⑤人才招聘会、现场开奖的彩票销售等活动。" },
    { id: "cuoti_180", subject: "ops", type: "single", stem: "国家“宪法日”是( )", options: ["12月1日", "12月4日", "12月11日", "12月14日"], answer: 1, explain: "国家“宪法日”是12月4日。 题库维护人：CZP" },
    { id: "cuoti_181", subject: "law", type: "single", stem: "《旅游法》规定，旅行社与旅游者订立合同或收取旅游者预付旅游费用后，因旅行社原因不能成行的，旅行社应在合理期限内通知旅游者，出境旅游 (含赴台游)应提前()通知旅游者", options: ["30日(不含30日)", "30日(含30日)", "7日(不含7日)", "7日(含7日)"], answer: 0, explain: "旅行社与旅游者订立合同或收取旅游者预付旅游费用后，因旅行社原因不能成行的，旅行社应在合理期限内通知旅游者，出境旅游(含赴台游)应提前30日(不含30日)通知旅游者，否则应向旅游者全额退还预付旅游费用，并按规定向旅游者支付违约金。" },
    { id: "cuoti_182", subject: "law", type: "single", stem: "身为一名导游帮助别人违法出境，根据《出境入境管理法》规定，处();情节严重的，处10日以", options: ["2000元以上1万元以下", "3000元以上5000元以下", "1000元以上5000元以下", "5000元以上50000元以下"], answer: 0, explain: "协助他人非法出境入境的，处2000元以上1万元以下罚款；情节严重的，处10日以上15日以下拘留，并处5000元以上2万元以下罚款，有违法所得的，没收违法所得。" },
    { id: "cuoti_183", subject: "nat", type: "single", stem: "从现在起，中国共产党的中心任务就是团结带领全国各族人民全面建成社会主义现代化强国、实现第二个百年奋斗目标，以()全面推进中华民族伟大", options: ["中国式现代化", "改革开放", "乡村振兴", "社会主义现代化"], answer: 0, explain: "从现在起，中国共产党的中心任务就是团结带领全国各族人民全面建成社会主义现代化强国、实现第二个百年奋斗目标，以中国式现代化全面推进中华民族伟大复兴。" },
    { id: "cuoti_184", subject: "law", type: "single", stem: "《民法典》规定，当事人应当遵循诚信原则，根据合同的性质、目的和交易习惯履行通知、()、保", options: ["协助", "守信", "保管", "诚信"], answer: 0, explain: "当事人应当遵循诚信原则，根据合同的性质、目的和交易习惯履行通知、协助、保密等义务。" },
    { id: "cuoti_185", subject: "law", type: "single", stem: "《不文明行为记录办法》规定，,旅游不文明行为当事人违反刑法的，“旅游不文明行为记录”信息保存期限为()", options: ["3～5年", "1～3年", "2～4年", "5～10年"], answer: 0, explain: "《不文明行为记录办法》规定，行为当事人违反刑法的，信息保存期限为3～5年。" },
    { id: "cuoti_186", subject: "nat", type: "tf", stem: "宁夏旅游资源中的“两山一河”指的是贺兰山、阴山和黄河。()", options: ["错", "对"], answer: 0, explain: "两山一河指的是贺兰山、六盘山、黄河。 题库维护人：CZP 笔记十随手记宁夏两山一河：贺兰山、六盘山、黄河" },
    { id: "cuoti_187", subject: "nat", type: "tf", stem: "江苏省流传下来的民歌有12800余首，苏北民歌 《好一朵茉莉花》广为流传。()", options: ["错", "对"], answer: 0, explain: "苏南民歌《好一朵茉莉花》(又名《茉莉花》)、苏北民歌《拔根芦柴花》广为流传。 题库维护人：CZP 笔记十随手记" },
    { id: "cuoti_188", subject: "nat", type: "tf", stem: "山东省是中国重要的重工业基地和全国工业门类最为齐全的省份，也是中国近代开埠最早的省份和中国最早实行对外开放政策的沿海省份之一。()", options: ["错", "对"], answer: 0, explain: "辽宁省是中国重要的重工业基地和全国工业门类最为齐全的省份，也是中国近代开埠最早的省份和中国最早实行对外开放政策的沿海省份之一。 题库维护人：CZP" },
    { id: "cuoti_189", subject: "nat", type: "single", stem: "被誉为“世界美食之都”称号的城市是( )", options: ["广州", "顺德", "潮州", "惠州"], answer: 1, explain: "2014年12月1日，联合国教科文组织授予广东顺德“世界美食之都”的称号，成为中国第二个获此殊荣的城市。 题库维护人：CZP" },
    { id: "cuoti_190", subject: "nat", type: "single", stem: "《玛纳斯》是( )的英雄史诗", options: ["蒙古族", "藏族", "柯尔克孜族", "回族"], answer: 2, explain: "柯尔克孜族《玛纳斯》是一部世代流传家喻户晓的长篇英雄史诗，描写了英雄玛纳斯及其七代子孙前仆后继、率领柯尔克孜人民与外来侵略者和各种邪恶势力进行斗争的事迹。《玛纳斯》体现了柯尔克孜人顽强不屈的民族性格和团结一致、 奋发进取的民族精神。它与藏族的《格萨尔王传》、蒙古族的《江格尔》一起，被誉为我国民族文学领域的“三大英雄史诗”。 题库维护人：CZP" },
    { id: "cuoti_191", subject: "ops", type: "single", stem: "素有“桂圆肉之乡”的称誉的地方是( )", options: ["合浦", "博白", "荔浦", "桂林"], answer: 1, explain: "广西特产美食：广西食品及果品有桂林豆腐乳和马蹄糕、荔浦芋头、兴安白果、博白(桂圆肉之乡)桂圆肉、阳朔金橘、恭城柿饼等。" },
    { id: "cuoti_192", subject: "ops", type: "single", stem: "藏族男女都喜欢戴的帽子是( )", options: ["金花帽", "尕帕", "狗皮帽", "号帽"], answer: 0, explain: "藏族男女都喜爱戴藏式金花帽，上身穿绸布长袖短褂，外套宽肥的藏袍，男女均穿箱僵或牛皮的藏靴。所以长袖、宽腰、长裙、长靴是藏族服饰的基本特征。" },
    { id: "cuoti_193", subject: "nat", type: "tf", stem: "1997年，国务院旅游主管部门正式批准开展中国公民出境旅游业务。()", options: ["错", "对"], answer: 0, explain: "1997年，香港回归，国家旅游局召开了出境旅游工作会议，正式批准开展中国公民出境旅游业务，推动了内地与香港出入境双向市场的起步发展，使我国旅游业呈现出国内游、出境游和入境游开始同步发展的新格局。 题库维护人：WYF 3÷GO" },
    { id: "cuoti_194", subject: "ops", type: "tf", stem: "汉字宋体是宋代产生的方便雕版印刷的新书体", options: ["错", "对"], answer: 0, explain: "随着印刷术的发展，雕版印刷被广泛使用，汉字进一步完善和发展，到了宋代产生了一种新型书体—宋体印刷字。 题库维护人：WYF" },
    { id: "cuoti_195", subject: "ops", type: "single", stem: "化繁为简、化圆为方、化弧为直，字体方正，讲究 “蚕头燕尾”“一波三折”是( )书体的特点", options: ["小篆", "汉隶", "行书", "楷书"], answer: 1, explain: "汉隶字形结构化繁为简、化圆为方、化弧为直， 字体方正，讲究“蚕头燕尾”“一波三折”。 题库维护人：WYF 墙" },
    { id: "cuoti_196", subject: "nat", type: "single", stem: "有“三三秀水清如玉，六六奇峰翠插天”之称的名山是()", options: ["庐山", "华山", "武夷山", "黄山"], answer: 2, explain: "曲折萦回的九曲溪贯穿于丹崖群峰之间，如玉带穿珍珠，人称“三三秀水清如玉，六六奇峰翠插天”,构成了奇幻百出的武夷山水之胜。 题库维护人：WYF" },
    { id: "cuoti_197", subject: "nat", type: "single", stem: "欧洲最大的海湾是(),它也是荷兰第二大城", options: ["海牙", "莱顿城", "鹿特丹", "阿姆斯特丹"], answer: 2, explain: "鹿特丹为荷兰第二大城市，欧洲最大的海港。 题库维护人：WYF" },
    { id: "cuoti_198", subject: "nat", type: "single", stem: "中唐画家( ),人称“画圣”,代表作为《送子天王", options: ["顾恺之", "展子虔", "阎立本", "吴道子"], answer: 3, explain: "中唐吴道子，人称“画圣”,有“吴带当风”之说，代表作《送子天王图》。 庆维 A. AIVC" },
    { id: "cuoti_199", subject: "ops", type: "single", stem: "毛笔在( )开始运用于简牍中，书法成为文人的基", options: ["夏商时期", "东周时期", "春秋战国时期", "秦汉时期"], answer: 2, explain: "春秋战国时期毛笔开始运用于简牍中，书法成为文人的基本功。 题库维护人：WYF" },
    { id: "cuoti_200", subject: "ops", type: "single", stem: "当今世界旅游主要由三个层次组成，分别是()", options: ["旅游机构、旅游者、旅游景点", "开放国家、特色城市、功能性旅游区域", "所有国家、所有城市、所有景区", "发达国家、发达城市、发达景区"], answer: 1, explain: "" },
    { id: "cuoti_201", subject: "law", type: "single", stem: "标志着我国导游队伍的建设和管理被纳入法律体系的事件是()", options: ["1989年，国家旅游局每年举办一次全国导游资格考试", "1999年，国务院颁发了《导游人员管理条例》", "2013年，《中华人民共和国旅游法》颁布", "2018年，《导游管理办法》颁布"], answer: 1, explain: "1999年5月国务院颁发的《导游人员管理条例》标志着我国导游队伍的建设和管理被纳入法律体系。 【记忆思路】 1999年：导游人员管理条例； 2013年：旅游法。" },
    { id: "cuoti_202", subject: "ops", type: "multi", stem: "今后导游服务的基本趋向包括()", options: ["导游方法多样化", "导游职业自由化", "导游手段科技化", "导游服务规范化", "导游内容的高知识化"], answer: [0, 2, 4], explain: "今后导游服务的基本趋向主要包括：导游方法多样化、导游手段科技化和导游内容高知识化。 具体而言，未来导游服务将呈现三大趋势： ●导游内容的高知识化：要求导游人员的知识储备既广博又专精。 ●导游手段科技化：先进科技将改变传统导游服务的格局和方式。 ●导游方法多样化：要求导游人员能说会道、多才多艺，并能积极参与各项互动活动。 易错提示：选项中的导游职业自由化和导游服务规范化属于现阶段的发展特点，并非未来的基本趋向，应注意区分。" },
    { id: "cuoti_203", subject: "ops", type: "single", stem: "旅游协议规定的，旅游者有权享受的服务项目是()", options: ["功能服务", "心理服务", "特殊服务", "项，特殊服务是指导游人员按照规范化服"], answer: 0, explain: "解析：功能服务是指旅游协议规定的、旅游者有权享受的服务项目。 A、C两项，心理服务又称情绪性服务，是指导游人员为调节游客在旅游过程中心理状态失衡所提供的服务。 D项，特殊服务是指导游人员按照规范化服务的要求落实旅游接待计划之外，为满足部分游客或个别游客的合理需求而提供的服务。" },
    { id: "cuoti_204", subject: "ops", type: "multi", stem: "下列各项中，()是导游服务的原则", options: ["宾客至上", "少数服从多数", "维护旅游者合法权利", "规范化服务与个性化服务相结合", "为大家服务"], answer: [0, 2, 3, 4], explain: "导游服务的原则主要包括以下内容： ●宾客至上、服务至上原则：对应选项 A.宾客至上。 ●为大家服务的原则：对应选项E.为大家服务。 ●维护游客合法权益、维护旅行社和导游人员合法权益的原则：对应选项 C.维护旅游者合法权利。 ·“合理而可能”的原则。 ●规范化服务和个性化服务相结合的原则：对应选项D.规范化服务与个性化服务相结合。 ●旅游推销的AIDA原则。 选项B.少数服从多数不属于导游服务的原则，因此不选。" },
    { id: "cuoti_205", subject: "ops", type: "multi", stem: "下列各项中，()是旅游业优质服务的基本要求", options: ["尊重他人", "标准服务", "真诚待人", "素质服务", "心理平衡"], answer: [0, 2], explain: "旅游业的优质服务既包括文明礼貌等良好的服务态度，又包括行、住、吃、游、购等综合性的服务内容。旅游业中的优质服务须把规范化服务与个性化服务密切结合起来，以“宾客至上”为主旨，以尊重他人、真诚待人为基本要求。" },
    { id: "cuoti_206", subject: "ops", type: "tf", stem: "导游服务的独立性强还表现在导游讲解也具有相对的独立性。()", options: ["错", "对"], answer: 1, explain: "本题说法正确。 导游服务的独立性强，不仅体现在导游需要独当一面地完成各项接待服务工作，还表现在导游讲解也具有相对的独立性。在旅游活动中，导游往往需要根据实际情况，独立构思、组织和进行讲解。" },
    { id: "cuoti_207", subject: "ops", type: "single", stem: "导游工作的服务性要求导游人员()", options: ["不卑不亢，一视同仁", "求同存异，实事求是", "认清角色，摆正位置", "不计名利，乐于奉献"], answer: 2, explain: "导游工作的服务性是指导游工作本质上是服务性工作，属于旅游服务工作的一种。 它提供的不是有形的物质产品，而是无形的服务，是一种感受或体验。 因此，每一位导游人员都应该认清自己的角色地位，摆正位置，决不能凌驾于旅游者之上，应把为旅游者提供满意的服务作为自己的责任。" },
    { id: "cuoti_208", subject: "ops", type: "multi", stem: "旅游业提倡向旅游者提供的服务为", options: ["知识服务", "标准化服务", "个性化服务", "素质服务", "爱心服务"], answer: [1, 2], explain: "旅游业提倡向旅游者提供的服务，是标准化服务与个性化服务的有机结合。 标准化服务(又称规范化服务)是由国家或行业主管部门制定并发布的统一标准， 导游人员应按照《导游服务质量》和《旅行社国内旅游服务质量要求》等标准向游客提供规范化的服务。 个性化服务(又称特殊服务)是导游人员在落实规范化服务的基础上，为满足部分或个别游客的合理需求而提供的额外服务。" },
    { id: "cuoti_209", subject: "ops", type: "multi", stem: "旅游期间，导游人员若要为旅游者提供有偿服务，根据“知悉真情权”的规定，必须", options: ["提供真实信息", "事先讲清价格", "服务产品安全可靠", "由旅游者自主选择", "按规定出具购物凭证或服务单据"], answer: [0, 1, 4], explain: "旅游期间，导游人员若要为旅游者提供有偿服务，根据“知悉真情权”的规定，必须做好以下几点工作： ●提供真实信息，让旅游者感受到自己的真诚； ●事先讲清价格，避免发生价格上的冲突； ●按规定出具购物凭证或服务单据，让旅游者放心。 选项C“服务产品安全可靠”和选项D“由旅游者自主选择”虽然也是导游服务中应遵循的原则，但不属于题干中针对有偿服务时“知悉真情权”所直接要求的核心工作内容。" },
    { id: "cuoti_210", subject: "ops", type: "tf", stem: "游客的旅游自由权包括旅行自由权和逗留权。()", options: ["错", "对"], answer: 1, explain: "游客的旅游自由权确实包含旅行自由权和逗留权两项基本内容，因此本题表述正确。 根据维护游客合法权益的原则，游客依法享有以下主要权利： ●旅游自由权：包括旅行自由权和逗留权 ●旅游服务自主选择权 ●旅游公平交易权 ●旅游服务内容知悉权 ●依约享受旅游服务权 ●人身和财物安全权 ●医疗、求助权 ●求偿权和寻求法律救援权" },
    { id: "cuoti_211", subject: "ops", type: "tf", stem: "导游讲解服务是指游客在目的地旅行时导游人员在参观游览地的导游讲解。()", options: ["错", "对"], answer: 1, explain: "导游讲解服务的范围更广，并不仅限于参观游览地的讲解。它还包括游客在目的地旅行途中的沿途讲解，以及座谈、访问和某些参观点的口译服务等。题目将讲解服务局限于“参观游览地”,表述不完整。" },
    { id: "cuoti_212", subject: "ops", type: "single", stem: "旅行游览过程中，“旅要速，游要缓”体现了导游服务技巧的()原则", options: ["把握旅游者心理", "引导旅游者审美", "灵活安排游览内容", "注重交往技巧"], answer: 2, explain: "“旅要速，游要缓”强调在旅行过程中，交通环节应追求效率，而游览环节则应放慢节奏、深入体验。这要求导游不能机械地执行计划，而应根据实际情况灵活安排游览内容，把握好游览的节奏与顺序，做到有张有弛。" },
    { id: "cuoti_213", subject: "ops", type: "multi", stem: "导游服务四原则既是导游员的服务原则， 也用来衡量导游员的()", options: ["服务意识", "服务态度", "服务质量", "基本素质", "工作能力"], answer: [1, 2, 4], explain: "导游服务四原则——“游客至上”“履行合同”“安全第一”和“合理而可能”原则，不仅是导游员提供优质服务的行动指南，也是衡量其职业表现的重要标准。 具体而言，这些原则主要用来衡量导游员的： B.服务态度(是否以游客为中心、热情周到) C.服务质量(是否严格履约、保障安全、 满足合理需求) E.工作能力(能否在复杂情境中灵活贯彻原则、妥善处理问题) 这四个原则相互关联、互为补充，共同构成了评价导游员服务水平的核心维度。" },
    { id: "cuoti_214", subject: "law", type: "multi", stem: "我国合格导游人员的职业品质主要表现在", options: ["爱国敬业", "尽职敬业", "遵纪守法", "高尚情操", "协调能力"], answer: [0, 1, 2, 3], explain: "爱国敬业：导游人员作为国家的形象代表，必须具有强烈的爱国情怀，热爱旅游事业，并致力于传播和弘扬中华文化。 尽职敬业：导游人员应当尽职尽责，为游客提供全面、准确、生动的导游服务，确保游客的满意度和安全性。 遵纪守法：导游人员必须遵守国家的法律法规和旅游行业的规章制度，不得有违法违规的行为，确保旅游活动的合法性和规范性。 高尚情操：导游人员应具备高尚的道德情操和良好的职业道德，尊重游客、尊重同事、尊重合作方，维护行业的良好风尚。 协调能力：虽然协调能力对于导游人员来说是一项重要的能力，但它更多地表现为一种职业技能或能力，而非职业品质。职业品质通常指的是更为内在、更为基础的职业素养。 综上所述，我国合格导游人员的职业品质主要表现在爱国敬业、尽职敬业、遵纪守法和高尚情操等方面。因此，正确答案为 ABCD。" },
    { id: "cuoti_215", subject: "ops", type: "multi", stem: "导游服务的特点包括()", options: ["社会性", "跨文化性", "独立性强", "脑体高度结合", "文化性"], answer: [1, 2, 3], explain: "导游服务的特点包括独立性强、脑体高度结合、客观要求复杂多变以及跨文化性。 本题中，选项A社会性和选项E文化性并非导游服务特有的个性特征，因此不选。" },
    { id: "cuoti_216", subject: "nat", type: "multi", stem: "世界各国的导游服务，除政治属性外，其共同特性有()", options: ["文化性", "从属性", "经济性", "涉外性", "民族性"], answer: [0, 2, 3], explain: "世界各国的导游服务，除政治属性外，其共同特性主要包括：社会性、文化性、服务性、经济性和涉外性。 本题中，选项A.文化性、C.经济性和 D. 涉外性均属于上述共同特性。选项B“从属性”和 E“民族性”不属于导游服务的共同特性范畴，因此不选。" },
    { id: "cuoti_217", subject: "ops", type: "single", stem: "超常服务一般是指()的服务", options: ["有人情味", "超标准", "超值", "非正常"], answer: 0, explain: "超常服务是指有人情味的服务，提供超常服务可以弥补其他导游工作中的不足。 提供人情味的服务要有针对性，从接触客人开始，尽可能多地找机会与客人面对面交谈，与他们建立正常的友谊伙伴关系， 从而了解他们的心理需求，为提供针对性的超常服务做准备。" },
    { id: "cuoti_218", subject: "ops", type: "single", stem: "实地口语导游亦称()", options: [")声像导游", "物化导游", "讲解导游", "口译导游"], answer: 2, explain: "实地口语导游亦称讲解导游，它包括导游人员在游客旅行、游览途中所做的介绍、 交谈和问题解答等导游活动，以及在参观游览途中所做的导游讲解。 核心要点：实地口语导游在导游服务中的核心地位是不可替代的，并将永远发挥着主导作用。" },
    { id: "cuoti_219", subject: "ops", type: "single", stem: "据统计，在国际旅游总消费中用于购物的部分约占()", options: ["30% 十", "40%", "45%", "50%"], answer: 3, explain: "据统计，在国际旅游总消费中用于购物的部分约占50在促销商品的过程中，导游人员的作用举足轻重，同时这也体现了导游服务性质中的经济性。" },
    { id: "cuoti_220", subject: "ops", type: "single", stem: "在旅行游览过程中，导游人员不仅要进行介绍、讲解，还要随时随地应游客的要求，帮助解决问题，这体现了导游服务具有()的特点", options: ["独立性强", "脑力体力高度结合", "复杂多变", "跨文化性"], answer: 1, explain: "解析：导游人员在旅行游览过程中，不仅要进行介绍、讲解，还要随时随地应游客的要求帮助解决问题。这体现了导游服务是脑力劳动与体力劳动高度结合的服务性工作。 具体来说，导游进行景点讲解、回答游客问题，需要运用所掌握的知识和智能来应对，这是一种艰苦而复杂的脑力劳动；同时，导游人员的工作量也相当大，尤其是在旅游旺季往往会连轴转陪同游客，体力消耗大。因此，题目中描述的现象正是脑力与体力高度结合的特点。" },
    { id: "cuoti_221", subject: "ops", type: "single", stem: "导游服务是导游代表被委派的旅行社，或", options: ["旅客", "游客", "旅行者同游客签订的合同，接待或陪同()旅行、游览，按组团合同或约定的内容和标准向其提供的旅游接待服务。", "旅游者"], answer: 1, explain: "题干描述的是导游服务的定义。导游服务的主体是具有导游资格的导游，服务的客" },
    { id: "cuoti_222", subject: "ops", type: "single", stem: "1 克拉等于多少克？", options: ["0.2 克", "0.5 克", "1 克", "2 克"], answer: [0], explain: "1 克拉 = 0.2 克。钻石、宝石的计量单位，别记成 0.5。" },
    { id: "cuoti_223", subject: "ops", type: "single", stem: "泡温泉时，应从低温到高温，逐次浸泡，每次（ ）分钟即可。", options: ["15～20", "20～25", "25～30", "30～35"], answer: [0], explain: "高血压和心脑血管疾病患者泡温泉控制在 20 分钟以内，因此泡温泉安全时间为 15–20 分钟。" },
    { id: "cuoti_224", subject: "ops", type: "single", stem: "进入高原后要不断少量喝水，以预防血栓。一般每天需补充（ ）毫升液体。", options: ["1000", "2000～3000", "3000", "4000"], answer: [1], explain: "导游业务教材 113 页，高原每日补充 2000–3000ml 液体。（原题答案错误，已更正）" },
    { id: "cuoti_225", subject: "ops", type: "single", stem: "根据十一版导游教材，入境旅客携带（ ），需要进行申报。", options: ["酒精饮料超过 1000 毫升（12 度以上）", "酒精饮料超过 1500 毫升（12 度以上），或香烟超过 400 支，或雪茄超过 100 支，或烟丝超过 500 克", "香烟超过 200 支", "雪茄超过 200 支"], answer: [1], explain: "十一版新版教材不再区分港澳居民与其他旅客免税酒水数量。酒精饮料超过 1500 毫升（12 度以上）、或香烟超过 400 支、或雪茄超过 100 支、或烟丝超过 500 克，均需申报。" },
    { id: "cuoti_226", subject: "ops", type: "single", stem: "退税物品共（ ）个大类 324 种。", options: ["13", "15", "21", "25"], answer: [2], explain: "退税物品含服装、鞋帽、化妆品、钟表、首饰、电器、医疗保健及美容器材、厨卫用具、家具、空调、电冰箱、洗衣设施、电视机、摄像设备、计算机、自行车、文具、体育用品等，共 21 个大类、324 种；不含禁止、限制出境物品（如食品饮料水果烟酒汽车摩托车等）。" },
    { id: "cuoti_227", subject: "ops", type: "single", stem: "下列不属于抗高原反应药的是（ ）。", options: ["铁皮石斛", "红景天", "高原康", "高原安"], answer: [0], explain: "进入高原可提前服用抗高原反应药，常用红景天、高原康、高原安等；铁皮石斛不属于抗高原反应药。" },
    { id: "cuoti_228", subject: "ops", type: "single", stem: "入境游客购买中药及中药制成品，导游提醒事项说法正确的是（ ）。", options: ["可随意购买麝香、犀牛角、虎骨等名贵中药材携带出境", "建议前往质量可靠、有信誉的大药店购买，海关仅允许携带合理自用范围的药材出境，严禁麝香、犀牛角、虎骨等中药材出境", "中药制品没有携带出境限额", "小药店购买的中药材也可全部顺利带出中国国境"], answer: [1], explain: "入境旅游者购买中药或中药制成品时，推荐到质量可靠、有信誉的大药店消费，告知海关准许携带出境的药物仅限合理自用范围；海关严禁携带麝香、犀牛角、虎骨等中药材出境。" },
    { id: "cuoti_229", subject: "ops", type: "single", stem: "旅游者携带人民币现钞入出境，限额（ ）元，超出限额的禁止出境。", options: ["1000", "5000", "10000", "20000"], answer: [3], explain: "入出境携带人民币现钞限额 2 万元。2 万元以下人民币现钞、折合 5000 美元及以下外币现钞无需申报；超过该限额需申报。" },
    { id: "cuoti_230", subject: "ops", type: "single", stem: "根据十一版导游教材，入境旅客携带下列哪项物品需要向海关申报？（ ）", options: ["香烟 350 支，雪茄 80 支，烟丝 300 克，12 度以上酒 1200 毫升", "香烟 400 支，雪茄 100 支，烟丝 500 克，12 度以上酒 1500 毫升", "香烟 420 支，雪茄 80 支，烟丝 300 克，12 度以上酒 1000 毫升", "香烟 300 支，雪茄 50 支，烟丝 200 克，12 度以上酒 1300 毫升"], answer: [2], explain: "入境旅客携带香烟超过 400 支、或雪茄超过 100 支、或烟丝超过 500 克、或 12 度以上酒精饮料超过 1500 毫升，需向海关申报。B 选项是“等于上限”，属于免申报临界值，未超过；C 选项香烟 420 支超过 400 支，故需申报。" },
    { id: "cuoti_231", subject: "ops", type: "multi", stem: "根据中国国际航空股份有限公司对行李运输的规定，下列表述正确的有（ ）。", options: ["生病的猫和狗可托运", "每件手提行李的长、宽、高三边分别不得超过 55 厘米、40 厘米、20 厘米", "管制刀具以外的菜刀、手术刀、射钉枪等利器都不能托运", "每件普通托运行李重量不小于 2 千克，不超过 32 千克", "每件普通托运行李的长、宽、高三边之和不得小于 60 厘米，且不得超过 203 厘米"], answer: [1, 3, 4], explain: "- A 错误：生病的猫、狗不予承运。 - B 正确：手提行李尺寸上限 55cm×40cm×20cm。 - C 错误：管制刀具不能托运；管制刀具以外的菜刀、手术刀、射钉枪等利器**可以办理托运**，但不能随身携带上飞机。 - D 正确：普通托运行李单件重量 2kg～32kg。 - E 正确：普通托运行李三边之和 60cm ≤ 尺寸 ≤ 203cm。" },
    { id: "cuoti_232", subject: "loc", type: "tf", stem: "吉林省是我国东北既沿边又沿海的省份。（ ）", options: ["错", "对"], answer: [0], explain: "" },
    { id: "cuoti_233", subject: "loc", type: "single", stem: "辽宁省有 5 个世居少数民族，即满族、蒙古族、回族、锡伯族和（ ）。", options: ["赫哲族", "朝鲜族", "鄂伦春族", "鄂温克族"], answer: [1], explain: "辽宁 5 个世居少数民族：满族、蒙古族、回族、朝鲜族、锡伯族。赫哲族、鄂伦春、鄂温克主要是黑龙江的世居少数民族。" },
    { id: "cuoti_234", subject: "loc", type: "single", stem: "辽宁省共有（　）家国家 5A 级旅游景区。", options: ["5 家", "6 家", "7 家", "8 家"], answer: [2], explain: "辽宁 7 家 5A：沈阳市植物园（世博园）、大连老虎滩海洋公园—老虎滩极地馆（同一家，别拆成两个）、大连金石滩、本溪水洞、鞍山千山、盘锦红海滩风景廊道、本溪桓仁五女山。" },
    { id: "cuoti_235", subject: "loc", type: "single", stem: "东北地区以“满家滩，凉水湾，海参螃蟹成筐搬”而知名的景区是（ ）。", options: ["辽宁金石滩", "吉林查干湖", "吉林松花湖", "黑龙江镜泊湖"], answer: [0], explain: "大连金石滩，当地民谣“满家滩，凉水湾，海参螃蟹成筐搬”。查干湖出名的是冬捕，不是海参螃蟹。" },
    { id: "cuoti_236", subject: "loc", type: "single", stem: "下列辽宁风物特产中，入选首批 100 个地理标志产品的是（ ）。", options: ["辽中玫瑰", "北镇葡萄", "大连海参", "盘锦花生"], answer: [0], explain: "入选首批 100 个地理标志产品的辽宁特产共 6 项：辽中玫瑰、桓仁冰酒、红崖子花生、盘锦大米、岫岩滑子蘑、东港大黄蚬。注意：大连海参知名度高，但不在这份首批名单内，属易错选项。" },
    { id: "cuoti_237", subject: "loc", type: "single", stem: "“无峰不奇，无石不峭，无庙不古，无处不幽”这一评价专门用于形容（　）。", options: ["黄山", "千山", "泰山", "华山"], answer: [1], explain: "“无峰不奇，无石不峭，无庙不古，无处不幽”形容的是辽宁鞍山千山景区。黄山名气大，容易混淆。" },
    { id: "cuoti_238", subject: "loc", type: "multi", stem: "下列属于辽宁世界文化遗产的有（　）。", options: ["九门口长城", "沈阳故宫", "盛京三陵（福陵、昭陵、永陵）", "五女山山城", "大连金石滩"], answer: [0, 1, 2, 3], explain: "辽宁 4 处世界文化遗产：九门口长城、沈阳故宫、盛京三陵（福陵、昭陵、永陵）、五女山山城。金石滩是国家 5A 景区、国家地质公园，不是世界文化遗产。" },
    { id: "cuoti_239", subject: "loc", type: "multi", stem: "下列自治县中，属于辽宁省满族自治县的是（ ）。", options: ["新宾", "喀左", "岫岩", "清原", "本溪"], answer: [0, 2, 3, 4], explain: "辽宁共 8 个少数民族自治县——6 个满族自治县（新宾、岫岩、清原、本溪、桓仁、宽甸）；2 个蒙古族自治县（喀左、阜新）。喀左是蒙古族自治县，是本题易错选项。" },
    { id: "cuoti_240", subject: "loc", type: "multi", stem: "下列属于辽宁特色美食/特产的有（ ）。", options: ["西塔大冷面", "那家白肉血肠", "老边饺子", "马家烧麦", "李连贵熏肉"], answer: [0, 1, 2, 3, 4], explain: "题干所列西塔大冷面、那家白肉血肠、杨家吊炉饼鸡蛋糕、老边饺子、马家烧麦、不老林糖、李连贵熏肉、四季抻面、王麻子菜馆北岳巴氏奶、金州樱桃，均为辽宁当地美食或特产。" },
    { id: "cuoti_241", subject: "loc", type: "multi", stem: "下列关于辽宁省特色产业的说法中，正确的是（ ）。", options: ["辽宁省是我国重要的老工业基地之一", "辽宁省是全国工业行业最全的省份之一", "辽宁省装备制造业比较发达", "辽宁省缺乏原材料工业", "辽宁省的石油化工业在全国占有重要位置"], answer: [0, 1, 2, 4], explain: "辽宁是东北老工业基地核心省份，工业体系完备，装备制造业发达，石化、冶金等原材料工业实力雄厚。D 错误，辽宁原材料工业实力很强，并不缺乏。" },
    { id: "cuoti_242", subject: "loc", type: "tf", stem: "紫貂是国家一级保护动物，其毛皮呈紫色。（ ）", options: ["错", "对"], answer: [0], explain: "" },
    { id: "cuoti_243", subject: "loc", type: "tf", stem: "吉林省东端的珲春最近处距日本海仅 4 千米，是吉林乃至中国对外贸易、对外交流的重要通道。（ ）", options: ["错", "对"], answer: [0], explain: "" },
    { id: "cuoti_244", subject: "loc", type: "single", stem: "吉林省正式建制称省是在（ ）。", options: ["清顺治十年", "清康熙十二年", "清雍正二十二年", "清光绪三十三年"], answer: [3], explain: "清康熙十二年修建吉林城，得名“吉林乌拉”（满语，沿江），只是地名起源；清光绪三十三年（1907 年）设吉林行省，吉林完成正式建制。记忆：康熙得名，光绪建省。" },
    { id: "cuoti_245", subject: "loc", type: "single", stem: "吉林省的人参产量占全世界的（ ）。", options: ["50%", "60%", "40%", "80%"], answer: [2], explain: "吉林人参产量占全国 60%，占全世界 40%。" },
    { id: "cuoti_246", subject: "loc", type: "single", stem: "下列港口中，位于吉林省境内的是（ ）。", options: ["大安港", "营口港", "丹东港", "葫芦岛港"], answer: [0], explain: "大安港是吉林省内河港口，国家一类内河口岸，在白城市大安市。营口港、丹东港、葫芦岛港都属于辽宁省的沿海港口。" },
    { id: "cuoti_247", subject: "loc", type: "multi", stem: "下列吉林人中，领导东北抗联第一路军的是（ ）。", options: ["王德林", "杨靖宇", "唐聚伍", "魏拯民", "王德泰"], answer: [1, 3, 4], explain: "杨靖宇、魏拯民、王德泰是东北抗联第一路军的主要领导人；王德林、唐聚伍属于早期抗日义勇军领袖，不属于抗联第一路军。" },
    { id: "cuoti_248", subject: "loc", type: "multi", stem: "下列关于朝鲜族花甲礼的说法中，正确的是（ ）。", options: ["又称“回甲宴”", "为 70 周岁的老人举行", "起源于朝鲜王朝", "父母准备丰盛的宴席", "子女们按长子、长女、次子、次女顺序敬酒磕头"], answer: [0, 2], explain: "- A 正确：花甲礼又称回甲宴。 - B 错误：是 60 周岁，不是 70 岁。 - C 正确：起源于朝鲜王朝。 - D 错误：是子女为父母准备宴席，不是父母准备。 - E 错误：敬酒磕头顺序是长子→次子→长女→次女。" },
    { id: "cuoti_249", subject: "loc", type: "multi", stem: "下列机场中，位于吉林省内的机场是（ ）。", options: ["龙嘉机场", "平房机场", "白山机场", "延吉机场", "三家子机场"], answer: [0, 2, 3], explain: "龙嘉机场（长春龙嘉国际机场）、白山机场（长白山机场）、延吉机场（延吉朝阳川机场）都在吉林省；平房机场、三家子机场属于黑龙江省。" },
    { id: "cuoti_250", subject: "loc", type: "multi", stem: "下列吉林省的景区中，属于国家 5A 级旅游景区的是（ ）。", options: ["长白山", "五女峰", "伪满皇宫", "六鼎山", "净月潭"], answer: [0, 2, 3, 4], explain: "长白山、伪满皇宫、六鼎山、净月潭都是吉林 5A 景区；五女峰是 4A 级景区，不属于 5A。 吉林共 9 处 5A：长白山、伪满皇宫、净月潭、长影世纪城、六鼎山、世界雕塑公园、高句丽文物古迹、查干湖、大安嫩江湾。" },
    { id: "cuoti_251", subject: "loc", type: "single", stem: "下列黑龙江省的机场中，地处东北亚中心位置的是（ ）。", options: ["哈尔滨平房机场", "哈尔滨太平国际机场", "大庆萨尔图机场", "伊春林都机场"], answer: [1], explain: "哈尔滨太平国际机场地处东北亚中心位置，是东南亚至北美航线的经停点，也是黑龙江最大的机场、一类航空口岸。" },
    { id: "cuoti_252", subject: "loc", type: "tf", stem: "黑龙江省拥有水运口岸 14 个。（ ）", options: ["错", "对"], answer: [0], explain: "" },
    { id: "cuoti_253", subject: "loc", type: "single", stem: "黑龙江省拥有国家 5A 级旅游景区（ ）家。", options: ["4", "5", "6", "7"], answer: [3], explain: "2024 年 12 月齐齐哈尔扎龙生态旅游区成功晋级 5A，黑龙江 5A 景区总数更新为 7 家。 7 家名单：哈尔滨太阳岛、五大连池、镜泊湖、伊春汤旺河区林海奇石、漠河北极村、虎林市虎头、齐齐哈尔扎龙生态旅游区。 旧题库为 6 家，2024 年 12 月后新版为 7 家。" },
    { id: "cuoti_254", subject: "loc", type: "single", stem: "根据第七次全国人口普查数据，黑龙江省共有（ ）个少数民族。", options: ["51", "52", "53", "55"], answer: [3], explain: "根据七普，黑龙江省有 55 个少数民族，少数民族人口约 112 万，占全省总人口 3.52%。世居少数民族共 10 个：满族、朝鲜族、蒙古族、回族、达斡尔族、锡伯族、赫哲族、鄂伦春族、鄂温克族、柯尔克孜族。赫哲族是黑龙江独有的少数民族。" },
    { id: "cuoti_255", subject: "loc", type: "single", stem: "1954 年 6 月，撤销松江省建制，与黑龙江省合并为黑龙江省，同时将哈尔滨市改为（ ）并入黑龙江省。", options: ["直辖市", "省辖市", "自治区", "特别行政区"], answer: [1], explain: "1954 年 6 月，中央决定撤销松江省，与黑龙江省合并为新的黑龙江省；哈尔滨市不再是直辖市，改为省辖市并入黑龙江省。记忆：1954 年，哈市由直辖市→省辖市。" },
    { id: "cuoti_256", subject: "loc", type: "multi", stem: "关于黑龙江省少数民族语言文字特点，说法正确的有（ ）。", options: ["满族普遍使用汉语文", "回族普遍使用汉语文", "鄂伦春族有民族语言，无本民族文字", "赫哲族有本民族语言，无本民族文字", "蒙古族有本民族语言文字，大多数人通用汉语文"], answer: [0, 1, 2, 3, 4], explain: "满族、回族普遍使用汉语文；朝鲜族、蒙古族有本民族语言文字但大多数人通用汉语文；达斡尔、鄂伦春、鄂温克、赫哲族有本民族语言但无本民族文字，普遍使用汉语文；其余 43 个少数民族大多为开发建设时期迁入，绝大多数通用汉语文。" },
    { id: "cuoti_257", subject: "loc", type: "multi", stem: "黑龙江省的主要山脉有（ ）。", options: ["大兴安岭", "小兴安岭", "完达山", "大黑山", "长白山"], answer: [0, 1, 2], explain: "黑龙江三大主要山脉：大兴安岭、小兴安岭、完达山。大黑山在辽宁省；长白山主体在吉林省。" },
    { id: "cuoti_258", subject: "loc", type: "multi", stem: "下列关于黑龙江省世居少数民族人口数量说法正确的有（ ）。", options: ["满族人口超过 10 万", "朝鲜族人口超过 10 万", "蒙古族人口超过 10 万", "回族人口约 7.5 万，不足 10 万", "赫哲族人口在万人以上"], answer: [0, 1, 2, 3], explain: "黑龙江世居 10 个少数民族，人口超过 10 万的：满族、朝鲜族、蒙古族；回族约 7.5 万；达斡尔族约 3.4 万；赫哲族、鄂伦春、鄂温克、锡伯、柯尔克孜族人口均不足万人。赫哲族人口不足万人，故 E 错误。" },
    { id: "cuoti_259", subject: "law", type: "tf", stem: "旅游行业第一部专门法规是 1985 年国务院颁布的《旅行社管理暂行条例》。（ ）", options: ["错", "对"], answer: [1], explain: "" },
    { id: "cuoti_260", subject: "law", type: "single", stem: "我国旅游行业第一部专门法规是（ ）。", options: ["《导游人员管理条例》", "《旅行社管理暂行条例》", "《中华人民共和国旅游法》", "《导游服务规范》"], answer: [1], explain: "" },
    { id: "cuoti_261", subject: "ops", type: "single", stem: "中国旅行游览事业管理总局正式更名为中华人民共和国国家旅游局是在哪一年（ ）。", options: ["1978", "1982", "1985", "1999"], answer: [1], explain: "1982 年 8 月，中国旅行游览事业管理总局更名为中华人民共和国国家旅游局。" },
    { id: "cuoti_262", subject: "ops", type: "tf", stem: "1983 年 10 月确定马踏飞燕作为中国旅游标志。（ ）", options: ["错", "对"], answer: [1], explain: "" },
    { id: "cuoti_263", subject: "ops", type: "multi", stem: "关于我国旅游业发展历史，说法正确的有（ ）。", options: ["1979 年 9 月，旅游工作由政治接待型转为经济经营型", "1982 年 7 月，中国旅行游览事业管理总局和国旅总社政企分开", "1984 年外联权下放，各地各行业可以兴办旅行社", "1985 年出台《旅行社管理暂行条例》，是旅游行业第一部专门法规", "1988 年全国旅行社数量接近 1600 家"], answer: [0, 1, 2, 3, 4], explain: "旅游发展时间线：1978 改革开放、总局改名；1979 年 9 月政治接待型转经济经营型；1980 年 6 月青旅总社成立；1982 年 7 月政企分开、1982 年 8 月更名国家旅游局；1983 年 10 月马踏飞燕；1984 年外联权下放；1985 年《旅行社管理暂行条例》；1988 年旅行社近 1600 家。" },
    { id: "cuoti_264", subject: "ops", type: "tf", stem: "导游服务作为一种职业正式登上历史舞台始于 1845 年的第一次有商业性导游陪同的旅游活动。（ ）", options: ["错", "对"], answer: [0], explain: "" },
    { id: "cuoti_265", subject: "ops", type: "single", stem: "导游服务作为一种职业正式登上历史舞台的标志是（ ）。", options: ["1841 年禁酒大会", "1845 利物浦之行", "1846 苏格兰之旅", "1855 巴黎包价旅游"], answer: [2], explain: "" },
    { id: "cuoti_266", subject: "ops", type: "single", stem: "托马斯·库克组织的第一次大规模、纯粹商业目的的旅游活动是（ ）。", options: ["1841 禁酒大会", "1845 利物浦之行", "1846 苏格兰之行", "1872 环球旅行"], answer: [1], explain: "" },
    { id: "cuoti_267", subject: "ops", type: "tf", stem: "1841 年禁酒大会，属于商业性质的团体旅游活动。（ ）", options: ["错", "对"], answer: [0], explain: "" },
    { id: "cuoti_268", subject: "ops", type: "multi", stem: "关于托马斯·库克的旅游事件，说法正确的有（ ）。", options: ["1841 年禁酒大会，世界首次团体公众旅游（非商业）", "1845 利物浦之行，首次大规模纯粹商业目的的旅游", "1846 苏格兰之行，首次配备商业导游陪同", "1855 巴黎之行，世界第一次包价旅游", "1892 年推出旅行流通券（旅游支票）"], answer: [0, 1, 2, 3, 4], explain: "1841 禁酒大会（非商业）；1845 利物浦（首次大规模纯商业旅游）；1846 苏格兰（首次配商业导游）；1855 巴黎（首次包价）；1865 库克父子公司成立迁伦敦；1872 首次环球旅行；1892 旅行流通券（旅游支票）。" },
    { id: "cuoti_269", subject: "ops", type: "tf", stem: "世界上第一家商业性旅行社是 1841 年托马斯·库克在莱斯特创办的旅行社。（ ）", options: ["错", "对"], answer: [0], explain: "" },
    { id: "cuoti_270", subject: "ops", type: "single", stem: "世界上第一家商业性旅行社创办于（ ）。", options: ["1841 年", "1845 年", "1846 年", "1855 年"], answer: [1], explain: "" },
    { id: "cuoti_271", subject: "ops", type: "tf", stem: "托马斯·库克创办的世界第一家商业性旅行社，服务宗旨是“为一切旅游公众服务”。（ ）", options: ["错", "对"], answer: [1], explain: "" },
    { id: "cuoti_272", subject: "ops", type: "single", stem: "导游服务是一种通过提供一定的劳务活动，提供一定的服务产品，创造特定（ ）的劳动。", options: ["社会价值", "交换价值", "使用价值", "个人价值"], answer: [2], explain: "导游服务属于非生产劳动，通过劳务活动、提供服务产品，创造特定使用价值。易错陷阱：容易误选社会价值。" },
    { id: "cuoti_273", subject: "ops", type: "single", stem: "导游服务属于（ ）。", options: ["生产劳动", "非生产劳动", "物质生产劳动", "体力劳动"], answer: [1], explain: "" },
    { id: "cuoti_274", subject: "law", type: "tf", stem: "《导游人员管理条例》于 1999 年 5 月实施，该条例的出台标志我国导游队伍建设有了法律保障。（ ）", options: ["错", "对"], answer: [1], explain: "" },
    { id: "cuoti_275", subject: "law", type: "single", stem: "我国导游队伍建设有了法律保障的标志性事件是（ ）。", options: ["2013《旅游法》施行", "1999 年 5 月《导游人员管理条例》实施", "2024 版《导游服务规范》实施", "2001 年合资旅行社成立"], answer: [1], explain: "" },
    { id: "cuoti_276", subject: "loc", type: "single", stem: "江苏省在（ ）时期已有“苏常熟，天下足”的民谚广为流传。", options: ["唐代", "元代", "宋代", "清代"], answer: [2], explain: "两宋时期江苏农业发达，成为全国重要粮仓，“苏常熟，天下足”民谚在宋代广为流传。易错：易混为唐代，唐代是“忆昔开元全盛日”，该谚语不属于唐代。" },
    { id: "cuoti_277", subject: "loc", type: "multi", stem: "江苏省被列入世界文化遗产的是（ ）。", options: ["夫子庙-秦淮河", "明孝陵", "中国大运河（江苏段）", "苏州古典园林", "中国黄（渤）海候鸟栖息地"], answer: [1, 2, 3], explain: "江苏世界文化遗产 3 处 = 苏州古典园林、明孝陵、中国大运河（江苏段）。夫子庙-秦淮河不是世界文化遗产；中国黄（渤）海候鸟栖息地属于世界自然遗产，不是文化遗产。" },
    { id: "cuoti_278", subject: "loc", type: "single", stem: "新亚欧大陆桥又名“第二亚欧大陆桥”，是从江苏省连云港市到（ ）的国际化铁路交通干线。", options: ["布列斯特", "华沙", "柏林", "鹿特丹港"], answer: [3], explain: "新亚欧大陆桥（第二亚欧大陆桥），东起点江苏连云港，西终点荷兰鹿特丹港。" },
    { id: "cuoti_279", subject: "loc", type: "single", stem: "下列少数民族中，（ ）是江苏省世居的少数民族。", options: ["苗族", "壮族", "回族", "彝族"], answer: [2], explain: "回族是江苏世居少数民族，在江苏少数民族人口中占比最高，江苏设有回族自治乡。苗族、壮族、彝族不属于江苏世居少数民族。" },
    { id: "cuoti_280", subject: "loc", type: "multi", stem: "“长江三鲜”是指（ ）。", options: ["鲟鱼", "鲥鱼", "银鱼", "刀鱼", "河豚"], answer: [1, 3, 4], explain: "银鱼属于太湖三白（银鱼、白鱼、白虾），不是长江三鲜；鲟鱼不是长江三鲜。" },
    { id: "cuoti_281", subject: "loc", type: "multi", stem: "下列历史人物中，（ ）是近代民族工业的重要创始人。", options: ["荣德生", "刘国钧", "周培源", "刘海粟", "张謇"], answer: [0, 1, 4], explain: "张謇、荣德生、刘国钧是近代民族工业实业家；周培源是物理学家；刘海粟是画家。" },
    { id: "cuoti_282", subject: "loc", type: "multi", stem: "下列平原地形中，江苏省主要由（ ）组成。", options: ["苏北平原", "黄淮平原", "江淮平原", "滨海平原", "淮北平原"], answer: [0, 1, 2, 3], explain: "江苏的平原包含苏北平原、黄淮平原、江淮平原、滨海平原、长江三角洲平原。淮北平原主体在安徽省，不属于江苏。" },
    { id: "cuoti_283", subject: "loc", type: "single", stem: "下列建筑（群）中，最能体现上海“海派建筑”石库门风格的是（ ）。", options: ["金茂大厦", "上海新天地", "上海展览中心", "万国建筑群"], answer: [1], explain: "上海新天地改造保留石库门，是海派石库门建筑代表；万国建筑群（外滩）属西式古典建筑，不是石库门；金茂大厦是现代摩天大楼；上海展览中心是俄式风格建筑。" },
    { id: "cuoti_284", subject: "loc", type: "single", stem: "下列景点中，（ ）是上海陆上的最高点。", options: ["薛山", "天马山", "凤凰山", "乌龟山"], answer: [1], explain: "天马山海拔 99.8 米，是上海陆上最高点，石碑“佘山之巅”，属佘山山系残丘。补充：上海全域最高峰是大金山岛（103.4 米，海上岛屿）。" },
    { id: "cuoti_285", subject: "loc", type: "multi", stem: "下列动物中，（ ）是上海人在商家开业时的迎接习俗。", options: ["黄牛", "雄鸡", "山羊", "鲤鱼", "生猪头"], answer: [1, 3, 4], explain: "上海商家开业接财神供奉三牲：雄鸡、鲤鱼、生猪头。鲤鱼谐音“利余”，又叫元宝鱼，寓意送元宝。黄牛、山羊不属于该习俗。" },
    { id: "cuoti_286", subject: "loc", type: "multi", stem: "下列岛屿中，属于上海北面长江入海处的岛屿是（ ）。", options: ["佘山岛", "崇明岛", "横沙岛", "长兴岛", "平潭岛"], answer: [1, 2, 3], explain: "上海北面长江入海口三岛为崇明岛、长兴岛、横沙岛；崇明岛是中国第三大岛。佘山岛在上海东海海域，不在长江入海口；平潭岛属于福建。" },
    { id: "cuoti_287", subject: "loc", type: "multi", stem: "属于上海 5A 级旅游景区的有（ ）。（截止 2025 年 12 月，共 5 家）", options: ["东方明珠广播电视塔", "上海野生动物园", "上海科技馆", "中国共产党一大·二大·四大纪念馆景区", "西沙明珠湖景区"], answer: [0, 1, 2, 3, 4], explain: "5 家全部：东方明珠、上海野生动物园、上海科技馆、中共一大·二大·四大纪念馆景区（2021 年获评 5A）、西沙明珠湖景区（崇明，2024 年获评，上海最新 5A）。" },
    { id: "cuoti_288", subject: "loc", type: "multi", stem: "下列食物中，（ ）是上海市民早餐的四大金刚。", options: ["大饼", "油条", "粢饭", "豆浆", "包子"], answer: [0, 1, 2, 3], explain: "上海早点四大金刚：大饼、油条、粢饭、豆浆。包子不属于四大金刚。" },
    { id: "cuoti_289", subject: "loc", type: "tf", stem: "河南还是全国重要的矿产资源大省和矿业大省，优势矿产可归纳为钼、金、铝、银“四大金属矿产”以及天然碱、盐矿、耐火黏土、萤石、珍珠岩、水泥灰岩、石墨“七大非金属矿产”。（ ）", options: ["错", "对"], answer: [1], explain: "" },
    { id: "cuoti_290", subject: "loc", type: "single", stem: "（ ）是中国历史上最早的关隘。", options: ["山海关", "嘉峪关", "函谷关", "居庸关"], answer: [2], explain: "河南拥有中国历史上最早的关隘——函谷关。区分：山海关是天下第一关（明代）；嘉峪关是天下第一雄关、明代长城西端起点；居庸关在北京附近。配套考点：最早的关隘 = 函谷关；最早的佛寺 = 白马寺。" },
    { id: "cuoti_291", subject: "loc", type: "single", stem: "河南浚县一年一度的“（ ）”闻名遐迩，是中原民俗文化的活化石。", options: ["盘古山庙会", "正月庙会", "中岳庙会", "火神台古庙会"], answer: [1], explain: "浚县正月古庙会又称华北第一古庙会，中原民俗文化活化石（河南鹤壁浚县）；宝丰马街书会是河南平顶山，中国曲艺的活化石、全国最大露天曲艺集会。区分：盘古山庙会（泌阳）、中岳庙会（登封嵩山）、火神台古庙会（商丘）。" },
];
  ...
  /* 状态衰减：每分钟衰减点数（全小生物、四项状态共用这一个系数）。
     v1.35：1/30 → 1/60。玩家反馈小生物一多（12 只以上）四项状态掉得太快、照顾不过来：
       旧值约 2 分钟掉 1 点 → 一天掉 48 点 → 从满值放到空只要 ~2.1 天，
       而一次基础护理最多补 +42，等于「天天都照顾也追不上」。
     新值约 1 小时掉 1 点 → 一天掉 24 点 → 满值到空 ~4.2 天，
       一次基础护理（+30~42）就够它撑一整天以上，「每天点一下」跟得上。
     仍然保留「每天回来看看」的节奏（状态照样在掉），但不再逼人连轴转。 */
  const DECAY_PER_MIN = 1 / 60;
